    ...
    <header>
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                <div class="container-fluid">
                  ...
                  <li class="nav-item ">
                    <a class="nav-link " href="menumovie.php">Movie</a>
                  </li>
                    </ul>
                    <form class="d-flex">
...
if ($result->num_rows > 0) {
    ...
    echo "<th> นามสกุล";echo "</th>";
    echo "<th width = 500> รายละเอียด";echo "</tr>"; 
    //output data of each row
 while($row = $result->fetch_assoc()) {
  echo 
  "<td>".$row["Mname"]."</td>". 
  "</a><td>"."</a>". $row["MLastname"] . "</td>".
  "<td><a class = 'btn btn-success btn-sm'  href='memberdes.php?MID=$row[MID]'>"."ดูรายละเอียด"."</td>";
  echo "</tr>"."<br>";
  ...
  echo "<br> <a class = 'btn btn-info' href='insertmember.php'>Add</a>";
