                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="selectpromo.php">Promotion</a>
                      </li>
                      <li class="nav-item">
...
if ($result->num_rows > 0){
    ...
    echo "<tr bgcolor='blueviolet'>";   echo "<th>รหัสโปรโมชั่น"; echo "</th>";echo "<th> ชื่อโปรโมชั่น: ";echo "</th>"; echo "<th> วันผลิต"; echo "</th>";echo "<th> วันหมดอายุ"; echo "</th>";
    echo "</tr>"; 
    while($row = $result->fetch_assoc()){
        echo "<td><a href='editpromo.php?Promoid=$row[Promoid]'>".$row["Promoid"]."</td>"."</a><td>"."</a>".$row["Promoname"]."</td>"."</a><td>"."</a>"
        .$row["CDate"]."</td>"."</a><td>"."</a>".$row["ModDate"] ."</td>";
        echo "</tr>"."<br>";    
    ...
    echo "<br>";
    echo "<a class = 'btn btn-light' href='insertpromo.php'>Add New Promotion</a>";
