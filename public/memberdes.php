...
{
  die("<br><span class='badge bg-danger'>connection failed".$conn->connect_error);
}
echo "<br><span class='badge bg-success'>Connection success</span>";
...
if ($result->num_rows > 0) {
    ...
    echo "<th> รหัสสมาชิก";echo "</th>";
    echo "<th> ชื่อสมาชิก";echo "</th>";
    echo "<th> นามสกุลสมาชิก";echo "</th>"; 
    echo "<th> อีเมล";echo "</th>"; 
    echo "<th> เบอร์";echo "</tr>";   
    //output data of each row
 while($row = $result->fetch_assoc()) {
  echo 
  "</a><td>"."</a>". $row["MID"] . "</td>".
  "</a><td>"."</a>". $row["Mname"] . "</td>".
  "</a><td>"."</a>". $row["MLastname"] . "</td>".
  "</a><td>"."</a>". $row["Email"] . "</td>".
  "</a><td>"."</a>" . $row["Tel"] . "</td>";
  echo "</tr>"."<br>";     
  ...
  echo "<br> <a class = 'btn btn-danger' href='menumember.php'>ย้อนกลับ</a>";
